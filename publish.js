var emails = [
    'contact@laowaiav.com'
];
var newestUrls = [
    'https://laowaiav.com'
];
var otherUrls = [
    'https://laowaiav.github.io'
];
var foreverUrls = [
    'https://laowaiav.com'
];
var notices = [
	...
	'* 大陆地区用户我们强烈建议您收藏当前页面(laowaiav.github.io)。'
];
...
window.onload = function () {
    ...
    logoElem.innerHTML = '<h1 class="flag">老外AV</h1>'
    mainElem.appendChild(logoElem);

    // newest urls
    var newestFieldElem = createFieldElem({title: '老外AV最新地址', items: newestUrls, text: '请使用https://协议访问老外AV'});
    ...
    // forever urls
    var foreverFieldElem = createFieldElem({title: '老外AV永久地址', items: foreverUrls});
